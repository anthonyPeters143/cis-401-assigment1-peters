...
Description --------------------------------------------------------
Assignment 1 is a server/client software that connects two computers
...
access a dictionary data-bank stored on a remote server. Will accept
an input of just a word with no numeric characters allowed. If
input is incorrect or not found then server will report with a not
